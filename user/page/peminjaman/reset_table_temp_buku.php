...
<table class="table table-striped table-bordered table-hover" id="dataTables-example-temp-buku">
  ...
  <tbody>
      <?php
        $no = 1;
        $sql = $conn -> query("TRUNCATE TABLE tb_temp_buku");
      ...
      <tr>
        ...
        <td>
          <a class="btn btn-danger hapus_temp_buku" data-id="<?php echo $data['isbn']; ?>" href="javascript:void(0)"><i class="material-icons md-18">delete</i></a>
        </td>
      </tr>
      <?php } ?>
    </tbody>
