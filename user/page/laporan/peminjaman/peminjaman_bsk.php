...
<a target="_blank" href="../cetak_laporan/laporan_detil_peminjaman_kembali.php" class="btn btn-primary" style="margin-bottom: 10px"><i class="material-icons md-18">print</i> Cetak Laporan</a>
