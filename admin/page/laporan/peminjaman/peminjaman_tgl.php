...
<div class="panel panel-default">
  <div class="panel-heading">
     <h1>Laporan Peminjaman Per 30 Hari Terakhir</h1>
   </div>
   <div class="panel-body">
    <div class="table-responsive">
      <table class="table table-striped table-bordered table-hover" id="dataTables-example-tanggal">
        <thead>
            <tr>
                <th>No</th>
                <th>Kode Pinjam</th>
...
<a target="_blank" href="../cetak_laporan/laporan_peminjaman_tgl.php" class="btn btn-primary" style="margin-bottom: 10px"><i class="material-icons md-18">print</i> Cetak Laporan</a>
...
<div class="panel panel-default">
  <div class="panel-heading">
     <h1>Laporan Detil Peminjaman Per 30 Hari Terakhir</h1>
   </div>
   <div class="panel-body">
    <div class="table-responsive">
      <table class="table table-striped table-bordered table-hover" id="dataTables-example-tanggal2">
        <thead>
            <tr>
                <th>No</th>
                <th>Kode Pinjam</th>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td><?php echo $data2['tgl_harus_kembali'];?></td>
...
<a target="_blank" href="../cetak_laporan/laporan_detil_peminjaman_tgl.php" class="btn btn-primary" style="margin-bottom: 10px"><i class="material-icons md-18">print</i> Cetak Laporan</a>
